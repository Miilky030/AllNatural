   ...
   <div class="flex">
      ...
      <select name="category" class="box" required>
         <option value="" {{ $data->category==""??'selected' }} disabled>Seleccionar categoría</option>
            ...
            <option {{ $data->category=="Línea Infantil"??'selected' }}  value="Línea Infantil">Línea Infantil</option>
            <option {{ $data->category=="Línea Masculina"??'selected' }}  value="Línea Masculina">Línea Masculina</option>
